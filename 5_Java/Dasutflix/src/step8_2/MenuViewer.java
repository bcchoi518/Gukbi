...
public class MenuViewer {
	...
	static void showLogIn() throws InterruptedException {
		...
		System.out.println("������"
				+ "�뵆 �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �뵍");
		System.out.print("\t\t\t�뼞 SignIn(1)");
		System.out.print("\t\t�뼞 SignUp(2)");
		System.out.println("\t\t�뼞 Exit(3)");
		System.out.println("������"
				+ "�뵒 �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �뵖");
		System.out.println();
	...
	static void showUserMenu(User user) throws NotExistException, InterruptedException {
		...
		System.out.println("������"
				+ "�뵆 �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �뵍");
		System.out.print("      \t\t�뼞 LogOut(0)  ");
		System.out.print("\t �뼞 Profile(1)  ");
//		System.out.println("?占쏙옙???????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????占쏙옙");
		System.out.print("   �뼞 Contents(2)");
		System.out.println("     �뼞 Configuration(3)");
		System.out.println("������"
				+ "�뵒 �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �뵖");
		System.out.println();
		System.out.print("    �������������������������������������������������������� �뾿 "+user.pf.getNickname() + ""+ "> ");
	}// end showUserMenu
	...
	static void showAdminMenu() throws InterruptedException {
		...
		System.out.println("������"
				+ "�뵆 �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �뵍");
		System.out.print(" "+" "+"\t�뼞 LogOut(0)");
		System.out.print("\t�뼞 UserManagement(1)");
		System.out.print("\t�뼞 ContentsManagement(2)");
		System.out.println("\t    �뼞 ChangePassword(3)");
		System.out.println("������"
				+ "�뵒 �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �� �뵖");
		System.out.println();
		System.out.print("    �������������������������������������������������������� �뾿  Admin> ");
	}// end showAdminMenu
