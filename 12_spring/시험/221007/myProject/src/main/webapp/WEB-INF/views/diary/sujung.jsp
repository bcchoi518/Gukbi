...
<form name="DirForm">
	...
	<table border="1" align="center" width="80%">
		<tr>
			<td>title</td>
			<td><input type="text" name="title" style="width:100%" value="${requestScope.dto.title }"></td>
		</tr>
		<tr>
			<td>내용</td>
			<td><textarea name="content" rows="10" cols="90">${requestScope.dto.content }</textarea></td>
		</tr>
		<tr>
...
<script>
	function save() {
		if (confirm('OK?')) {
			document.DirForm.action = '${path }/diary/sujungProc';
