...
|
<a href="#" onclick="move('guestBookMybatis_sujung.do','${requestScope.dto.no }')">수정</a>
|
<a href="#" onclick="move('guestBookMybatis_sakje.do','${requestScope.dto.no }')">삭제</a>
|
</div>
