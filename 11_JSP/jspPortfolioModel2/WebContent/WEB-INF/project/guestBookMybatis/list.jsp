...
<table border="0" width="80%" align="center">
	...
	<c:forEach var="guestBookMybatisDto" items="${requestScope.list }">
		<tr>
			<td>
				<table border="1" width="100%" align="center">
					<tr>
					...
					<tr>
						<td colspan="4" style="height: 200px; padding:15px; vertical-align: top; position: relative;">
							...
							<div style="float:right; bottom:15px; right:15px; position: absolute;" >
								<a href="#" onclick="move('guestBookMybatisMybatis_sujung.do','${guestBookMybatisDto.no }')">수정</a>
								/
								<a href="#" onclick="move('guestBookMybatisMybatis_sakje.do','${guestBookMybatisDto.no }')">삭제</a>
							</div>
						</td>
					</tr>
				</table>
...
|
<a href="${requestScope.path }/guestBookMybatis_servlet/guestBookMybatis_list.do" >전체목록</a>
|
...
<script>
	...
	function search() {
		if (confirm('searchOK?')) {
			document.searchForm.action = '${requestScope.path }/guestBookMybatis_servlet/guestBookMybatis_search.do';
	...
	function goPage(value1) {
		location.href = '${requestScope.path }/guestBookMybatis_servlet/guestBookMybatis_list.do?pageNumber='+ value1 +'&searchGubun=${requestScope.searchGubun }&searchData=${requestScope.searchData }';
	}//goPage
</script>