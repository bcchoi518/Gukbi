...
public class MovieUser {
	...
	void userMenu() {
		...
		for (int j = 0; j < 3; j++) {
			...
			for (int i = 0; i < 5; i++) {
				number++;
				tmpMovieArray[i] = tmpMovie; //j루프문 안에서 하나의 열 데이터 유지
				System.out.print("│");
				System.out.print(" ");
				...
				*/
				if(tmpMovieArray[i].title == null) { //제목 입력
					System.out.print("");
				} else if (tmpMovieArray[i].title.length() < 7) {
					System.out.print(tmpMovieArray[i].title);
				} else {
					System.out.print(tmpMovieArray[i].title.substring(0, 6)+"...");
				}
				
				if (tmpMovieArray[i].title == null||tmpMovieArray[i].title.length() < 3) {
					System.out.print("\t\t");
				} else {
					System.out.print("\t");
				}
			...
			for (int i = 0; i < 5; i++) { //장르 입력
				...
				*/
				...
				if(tmpMovieArray[i].genre==null) {
					System.out.print("\t\t");
				} else if (tmpMovieArray[i].genre.length() <= 3) {
					System.out.print("#" + tmpMovieArray[i].genre);
					System.out.print("\t\t");
				} else {
					System.out.print("#" + tmpMovieArray[i].genre);
